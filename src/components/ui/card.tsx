...
function CardTitle({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "font-heading text-[1.0625rem] leading-snug font-semibold tracking-[-0.01em] group-data-[size=sm]/card:text-[0.9375rem]",
        className
      )}
      {...props}
    />
